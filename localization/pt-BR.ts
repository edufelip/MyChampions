...
export const ptBR: Record<TranslationKey, string> = {
  ...
  'pro.plan.food_search.error': 'Busca de alimentos indisponível. Verifique as credenciais.',
  ...
  'common.nutrition.fats': 'Gorduras',
  ...
  'pro.predefined_plan.copy_independent_note':
    'Cada aluno recebe uma cópia independente. Alterações futuras na biblioteca não mudam planos já atribuídos.',
  ...
  'pro.plan.section.meals.support': 'Liste os alimentos, quantidades e horários para cada refeição.',
  ...
  'pro.plan.item.field.nutrition_quantity.label': 'Quantidade',
