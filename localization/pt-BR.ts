...
export const ptBR: Record<TranslationKey, string> = {
  ...
  'student.home.nutrition.section': 'Plano de Nutrição',
  ...
  'pro.students.empty.body':
    'Comece a transformar vidas adicionando seu primeiro aluno ou compartilhando seu link de convite.',
  ...
  'student.plan.cta.add_meal': 'Adicionar item de refeição',
  'student.plan.cta.add_session': 'Adicionar sessão de treino',
