...
export const ptBR: Record<TranslationKey, string> = {
  ...
  'student.training.empty.title': 'Comece sua própria jornada',
  'student.training.empty.body':
    'Você ainda não tem treinador, mas pode registrar seus próprios treinos e manter-se ativo!',
  'student.training.empty.cta': 'Criar treino',
