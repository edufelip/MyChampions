...
export const ptBR: Record<TranslationKey, string> = {
  ...
  'student.nutrition.empty.title': 'Nenhum plano ativo ainda',
  'student.nutrition.empty.body':
    'Você pode acompanhar suas próprias refeições ou esperar um profissional atribuir um plano personalizado.',
  'student.nutrition.empty.cta': 'Começar a acompanhar refeições',
