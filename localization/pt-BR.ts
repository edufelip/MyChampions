...
export const ptBR: Record<TranslationKey, string> = {
  ...
  'pro.plan.item.search.back': 'Voltar à busca',
  // Grupos musculares do YMove (usados para localizar o subtítulo nos resultados de busca)
  'ymove.muscle_group.chest': 'Peitoral',
  'ymove.muscle_group.back': 'Costas',
  'ymove.muscle_group.shoulders': 'Ombros',
  'ymove.muscle_group.biceps': 'Bíceps',
  'ymove.muscle_group.triceps': 'Tríceps',
  'ymove.muscle_group.forearms': 'Antebraços',
  'ymove.muscle_group.quads': 'Quadríceps',
  'ymove.muscle_group.hamstrings': 'Isquiotibiais',
  'ymove.muscle_group.glutes': 'Glúteos',
  'ymove.muscle_group.calves': 'Panturrilhas',
  'ymove.muscle_group.core': 'Core',
  'ymove.muscle_group.full_body': 'Corpo Inteiro',
  'ymove.cap_warning': 'Limite da biblioteca de exercícios atingido. Alguns vídeos podem não estar disponíveis.',
