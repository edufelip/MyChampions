...
export const ptBR: Record<TranslationKey, string> = {
  ...
  'student.home.cta_start_nutrition': 'Começar meu plano alimentar',
  ...
  'pro.plan.cta.add_food': 'Adicionar alimento',
  'student.plan.cta.add_food': 'Adicionar alimento',
  'pro.plan.cta.sort': 'Ordenar',
  'pro.plan.cta.sort_done': 'Concluir',
  'pro.plan.cta.move_up': 'Mover para cima',
  'pro.plan.cta.move_down': 'Mover para baixo',
  'common.cta.add': 'Adicionar',
  ...
  'student.home.title': 'Início',
  'student.home.welcome': 'Que bom ter você de volta',
  'student.home.your_day': 'Seu dia',
  'student.home.summary': 'Seus planos e progresso em um só lugar.',
  'student.home.professionals_short': 'Meus coaches',
  'student.home.error.connections': 'Não foi possível carregar as conexões profissionais.',
  'student.home.error.plans': 'Não foi possível carregar seus planos.',
  'student.home.error.hydration': 'Não foi possível carregar o progresso de hidratação.',
  'student.home.hydration.title': 'Hidratação',
  ...
  'student.home.hydration.goal_nutritionist': 'Meta definida pelo nutricionista',
  'student.home.hydration.no_goal': 'Crie um plano alimentar para definir sua meta diária de água',
  'student.home.nutrition.section': 'Plano Alimentar',
  'student.home.training.section': 'Treino do Dia',
  'student.home.pending_connection': 'Conexão Pendente',
  'student.home.cta_nutrition': 'Ver Plano',
  'student.home.cta_training': 'Iniciar Treino',
  'student.home.cta_professionals': 'Gerenciar profissionais',
  'student.home.cta_start_self': 'Começar por conta própria',
  'student.home.no_active_plan': 'Nenhum plano ativo',
  'student.home.nutrition.plan_available': 'Plano disponível para hoje',
  'student.home.training.plan_available': 'Sessão de corpo inteiro disponível',
  'student.home.offline.mode': 'Modo Offline',
  'student.home.offline.read_only_badge': 'Offline: Somente leitura',
  'student.home.loading.stale_title': 'Dados Desatualizados',
  'student.home.loading.stale_body': 'Última sincronização > 24h. Puxe para atualizar.',
  'student.nutrition.title': 'Nutrição',
  'student.nutrition.empty.title': 'Plano alimentar não disponível',
  'student.nutrition.empty.body':
    'Para receber um plano alimentar personalizado e atingir seus objetivos, você precisa do acompanhamento de um profissional qualificado.',
  'student.nutrition.empty.cta': 'Contratar nutricionista',
  'student.nutrition.empty.self_guided_cta': 'Criar meu plano alimentar',
  'student.nutrition.waiting.title': 'Seu nutricionista está preparando seu plano',
  'student.nutrition.waiting.body':
    'Sua conexão com o nutricionista está ativa. Você verá seu plano alimentar aqui quando ele for enviado.',
  'student.nutrition.waiting.cta': 'Ver meu nutricionista',
  ...
  'student.training.empty.cta': 'Contratar personal',
  'student.training.empty.self_guided_cta': 'Criar meu plano de treino',
  'student.training.waiting.title': 'Seu treinador está preparando seu plano',
  'student.training.waiting.body':
    'Sua conexão com o treinador está ativa. Você verá suas sessões de treino aqui quando o plano for enviado.',
  ...
  'student.training.no_exercises': 'Nenhum exercício definido para esta sessão.',
  'student.training.no_sessions': 'Nenhum treino atribuído.',
  'pro.home.title': 'Painel',
  'pro.home.subtitle': 'Prioridades, alunos e planos em um só lugar.',
  'pro.home.overview': 'Visão geral',
  'pro.home.active_students': 'Alunos ativos',
  'pro.home.pending_requests': 'Solicitações pendentes',
  'pro.home.connection_requests': 'Solicitações de conexão',
  'pro.home.connection_requests_body': '{count} aguardando sua análise.',
  'pro.home.needs_attention': 'Precisa da sua atenção',
  ...
  'pro.students.empty.title': 'Ainda não há alunos',
  'pro.students.empty.body': 'Comece a transformar vidas compartilhando seu link de convite.',
  ...
  'pro.students.bulk_assign.select_hint': 'Selecione os alunos para atribuir um plano.',
  ...
  'pro.student_profile.assignment.draft_pending': 'Rascunho pendente de envio',
  'pro.student_profile.assignment.awaiting': 'Ativo, aguardando plano',
  ...
  'shell.modal.body_description': 'Toque no botão abaixo para voltar à tela inicial.',
  ...
  'settings.account.header_title': 'Conta e Perfil',
  'settings.account.section.account': 'Conta',
  'settings.account.section.legal': 'Legal e Privacidade',
  'settings.account.section.support': 'Suporte',
  'settings.account.section.danger': 'Zona de Perigo',
  'settings.account.role.student': 'Aluno',
  'settings.account.role.professional': 'Profissional',
  ...
  'settings.account.language.picker_title': 'Escolher idioma',
  ...
  'settings.account.terms.label': 'Termos de Uso',
  'settings.account.contact.label': 'Falar com o suporte',
  'settings.account.app_version.label': 'Versão',
  'settings.account.sign_out.cta': 'Sair',
  'settings.account.sign_out.confirm_title': 'Sair da conta?',
  'settings.account.sign_out.confirm_body': 'Você será redirecionado para a tela de login.',
  ...
  'meal.builder.field.carbs.label': 'Carbo (g)',
  'meal.builder.field.carbs.placeholder': 'ex.: 45',
  'meal.builder.field.proteins.label': 'Proteína (g)',
  'meal.builder.field.proteins.placeholder': 'ex.: 38',
  'meal.builder.field.fats.label': 'Gordura (g)',
  ...
  'meal.photo_analysis.paywall.cta_upgrade': 'Fazer upgrade para desbloquear',
  'meal.photo_analysis.paywall.loading': 'Verificando assinatura\u2026',
  'pro.library.nutrition.title': 'Planos Alimentares',
  'pro.library.nutrition.empty': 'Nenhum plano alimentar ainda. Crie seu primeiro plano.',
  'pro.library.nutrition.cta_create': 'Criar plano alimentar',
  ...
  'pro.library.nutrition.helper':
    'Crie suas predefinições de dieta. Depois de atribuir a um aluno você só precisa fazer o ajuste fino.',
  'pro.library.training.helper':
    'Crie suas predefinições de treino. Depois de atribuir a um aluno você só precisa fazer o ajuste fino.',
  'pro.plan.nutrition.title.create': 'Criar plano alimentar',
  'pro.plan.nutrition.title.edit': 'Editar plano alimentar',
  ...
  'pro.plan.field.hydration_goal.label': 'Meta diária de água (ml)',
  'pro.plan.field.hydration_goal.placeholder': 'ex.: 2200',
  ...
  'pro.plan.section.meal_items': 'Itens da Refeição',
  'pro.plan.section.sessions': 'Sessões',
  'pro.plan.cta.add_meal': 'Adicionar refeição',
  ...
  'pro.plan.validation.hydration_goal_positive': 'A meta diária de água deve ser maior que zero.',
  ...
  'pro.student_profile.assignment.cta_view_edit': 'Ver/editar plano atribuído',
  'pro.plan.assign.success': 'Plano atribuído com sucesso.',
  'pro.plan.assign.error': 'Não foi possível atribuir o plano. Tente novamente.',
  ...
  'student.plan.session.field.name.placeholder': 'ex.: Treino de Perna',
  'pro.plan.field.nutrition_name.support': 'Título',
  'student.plan.field.nutrition_name.support': 'Título',
  'student.plan.field.hydration_goal.label': 'Meta diária de água (ml)',
  ...
  'student.plan.session.no_exercises': 'Adicione seu primeiro exercício aqui.',
  ...
  'student.plan.nutrition.item.no_sets': 'Toque para editar porção',
  'pro.plan.discard.title': 'Descartar alterações?',
  'pro.plan.discard.body': 'Você tem alterações não salvas. Tem certeza que deseja sair?',
  'pro.plan.discard.yes': 'Descartar',
  'pro.plan.discard.no': 'Continuar editando',
  'pro.plan.discard.success': 'Rascunho descartado com sucesso.',
  ...
  'pro.plan.item.field.notes.placeholder': 'ex.: Foco na postura',
  'pro.plan.item.field.nutrition_name.label': 'Nome do alimento / refeição',
  'pro.plan.item.field.nutrition_name.placeholder': 'ex.: Frango grelhado',
  'pro.plan.item.field.nutrition_quantity.label': 'Quantidade(g)',
  ...
  // Grupos musculares do serviço de exercícios (subtítulo na busca)
  'exercise.muscle_group.chest': 'Peitoral',
  'exercise.muscle_group.back': 'Costas',
  'exercise.muscle_group.shoulders': 'Ombros',
  'exercise.muscle_group.biceps': 'Bíceps',
  'exercise.muscle_group.triceps': 'Tríceps',
  'exercise.muscle_group.forearms': 'Antebraços',
  'exercise.muscle_group.quads': 'Quadríceps',
  'exercise.muscle_group.hamstrings': 'Isquiotibiais',
  'exercise.muscle_group.glutes': 'Glúteos',
  'exercise.muscle_group.calves': 'Panturrilhas',
  'exercise.muscle_group.core': 'Core',
  'exercise.muscle_group.full_body': 'Corpo Inteiro',
  ...
  'settings.account.support.field.body.placeholder': 'Como podemos ajudar?',
