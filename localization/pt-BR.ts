...
export const ptBR: Record<TranslationKey, string> = {
  ...
  'student.nutrition.water.cta_set_goal': 'Definir Meta Diária',
  ...
  'student.nutrition.water.goal.label': 'Meta (ml)',
  'student.nutrition.water.goal.placeholder': 'Meta (ml)',
  ...
  'pro.template.library.title': 'Modelos de Início',
  'pro.template.library.filter.label': 'Pesquisar modelos',
  'pro.template.library.empty': 'Nenhum modelo de início disponível.',
  'pro.template.clone.cta': 'Clonar modelo',
  'pro.template.clone.modal.title': 'Clonar modelo',
  'pro.template.clone.modal.label': 'Nome do novo plano',
  'pro.template.clone.modal.placeholder': 'ex. Meu plano personalizado',
  'pro.template.clone.validation.template_id_required': 'ID do modelo é obrigatório',
  'pro.template.clone.validation.invalid_template': 'Formato de ID do modelo inválido',
  'pro.template.clone.validation.name_required': 'Nome do plano é obrigatório',
  'pro.template.clone.validation.name_too_short': 'Nome do plano deve ter pelo menos 2 caracteres',
  'pro.template.clone.validation.name_too_long': 'Nome do plano não deve exceder 100 caracteres',
  'pro.template.clone.success': 'Modelo clonado com sucesso',
  'pro.template.clone.error': 'Falha ao clonar modelo. Tente novamente.',
  'pro.template.immutable_notice': 'Modelos de início são somente leitura. Clone para personalizar.',
  ...
  'pro.plan.cta.clone_template': 'Começar de um modelo',
  'pro.plan.template.picker_title': 'Escolha um modelo',
  'pro.plan.template.starter_label': 'Modelos Iniciais',
  'pro.plan.template.cta_use': 'Usar modelo',
