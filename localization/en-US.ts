export const enUS = {
  ...
  // YMove muscle group slugs (used to localize the subtitle in exercise search results)
  'ymove.muscle_group.chest': 'Chest',
  'ymove.muscle_group.back': 'Back',
  'ymove.muscle_group.shoulders': 'Shoulders',
  'ymove.muscle_group.biceps': 'Biceps',
  'ymove.muscle_group.triceps': 'Triceps',
  'ymove.muscle_group.forearms': 'Forearms',
  'ymove.muscle_group.quads': 'Quads',
  'ymove.muscle_group.hamstrings': 'Hamstrings',
  'ymove.muscle_group.glutes': 'Glutes',
  'ymove.muscle_group.calves': 'Calves',
  'ymove.muscle_group.core': 'Core',
  'ymove.muscle_group.full_body': 'Full Body',
  'ymove.cap_warning': 'Exercise library limit reached. Some videos may not be available.',
