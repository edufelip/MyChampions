export const enUS = {
  ...
  'student.home.welcome': 'Welcome back',
  'student.home.your_day': 'Your day',
  'student.home.summary': 'Your plans and progress at a glance.',
  'student.home.professionals_short': 'My coaches',
  'student.home.error.connections': 'Professional connections could not be loaded.',
  'student.home.error.plans': 'Your plans could not be loaded.',
  'student.home.error.hydration': 'Hydration progress could not be loaded.',
  ...
  'student.training.no_exercises': 'No exercises defined in this session.',
  'student.training.no_sessions': 'No sessions assigned.',
  'pro.home.title': 'Dashboard',
  'pro.home.subtitle': 'Priorities, students, and plans in one place.',
  'pro.home.overview': 'Overview',
  'pro.home.active_students': 'Active students',
  'pro.home.pending_requests': 'Pending requests',
  'pro.home.connection_requests': 'Connection requests',
  'pro.home.connection_requests_body': '{count} awaiting your review.',
  'pro.home.needs_attention': 'Needs attention',
  ...
  'pro.student_profile.assignment.draft_pending': 'Draft pending send',
  'pro.student_profile.assignment.awaiting': 'Active, awaiting plan',
  ...
  'pro.student_profile.tracking_review.loading': 'Loading tracking review...',
  'pro.student_profile.tracking_review.error': 'Could not load nutrition tracking. Try again.',
  'pro.student_profile.tracking_review.water_today': 'Today water progress',
  'pro.student_profile.tracking_review.meals_today': 'Today meal check-offs',
  'pro.student_profile.tracking_review.recent_portions': 'Recent portion logs',
  'pro.student_profile.tracking_review.empty_meals': 'No meals checked off today.',
  'pro.student_profile.tracking_review.empty_portions': 'No portion logs in the last seven days.',
  ...
  'pro.plan.error.cta_back_to_library': 'Back to library',
  ...
  'pro.student_profile.assignment.cta_resume_draft': 'Resume draft',
  'pro.student_profile.assignment.cta_discard': 'Discard',
  'pro.student_profile.assignment.cta_view_edit': 'View/edit assigned plan',
  ...
  'pro.plan.discard.success': 'Draft discarded successfully.',
  'pro.plan.discard.error': 'Could not discard draft.',
  ...
  'student.plan.error.cta_back_to_library': 'Back to library',
  ...
  'shell.modal.body_description': 'Tap the button below to return to the home screen.',
