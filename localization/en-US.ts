export const enUS = {
  ...
  'student.nutrition.empty.title': 'No active plan yet',
  'student.nutrition.empty.body':
    'You can track your own meals or wait for a professional to assign you a personalized plan.',
  'student.nutrition.empty.cta': 'Start tracking meals',
  ...
  'student.training.empty.title': 'Start your own journey',
  'student.training.empty.body':
    "You don't have a coach yet, but you can track your own workouts and stay active!",
  'student.training.empty.cta': 'Create a workout',
