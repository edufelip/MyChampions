export const enUS = {
  ...
  'pro.plan.food_search.error': 'Food search unavailable. Check credentials.',
  ...
  'pro.predefined_plan.copy_independent_note':
    "Each student gets an independent copy. Future library edits won't change assigned plans.",
  ...
  'pro.plan.cta.add_food': 'Add food',
  ...
  'pro.plan.section.meals.support': 'List the foods, quantities, and timings for each meal.',
  ...
  'pro.plan.draft.body': 'Would you like to restore the unsaved changes from your last session?',
  'pro.plan.draft.yes': 'Restore',
  'pro.plan.draft.no': 'Discard',
  ...
  'pro.plan.item.field.nutrition_quantity.label': 'Amount',
