export const enUS = {
  ...
  'student.nutrition.water.cta_set_goal': 'Set Daily Goal',
  ...
  'student.nutrition.water.goal.label': 'Goal (ml)',
  'student.nutrition.water.goal.placeholder': 'Goal (ml)',
  ...
  'pro.template.library.title': 'Starter Templates',
  'pro.template.library.filter.label': 'Search templates',
  'pro.template.library.empty': 'No starter templates available.',
  'pro.template.clone.cta': 'Clone template',
  'pro.template.clone.modal.title': 'Clone template',
  'pro.template.clone.modal.label': 'New plan name',
  'pro.template.clone.modal.placeholder': 'e.g. My custom plan',
  'pro.template.clone.validation.template_id_required': 'Template ID is required',
  'pro.template.clone.validation.invalid_template': 'Invalid template ID format',
  'pro.template.clone.validation.name_required': 'Plan name is required',
  'pro.template.clone.validation.name_too_short': 'Plan name must be at least 2 characters',
  'pro.template.clone.validation.name_too_long': 'Plan name must not exceed 100 characters',
  'pro.template.clone.success': 'Template cloned successfully',
  'pro.template.clone.error': 'Failed to clone template. Try again.',
  'pro.template.immutable_notice': 'Starter templates are read-only. Clone to customize.',
  ...
  'pro.plan.template.picker_title': 'Choose a template',
  'pro.plan.template.starter_label': 'Starter Templates',
  'pro.plan.template.cta_use': 'Use template',
