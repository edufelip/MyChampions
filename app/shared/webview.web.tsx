...
import { allowInsecureLocalhostForDevelopment, resolveSafeExternalUrl } from '@/features/platform/external-url';
...
export default function WebExternalLinkScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.color.canvas }]} testID="shared.webview.screen">
...
const styles = StyleSheet.create({
  ...
  button: { borderRadius: 999, minHeight: 44, paddingHorizontal: DsSpace.lg, justifyContent: 'center' },
});
