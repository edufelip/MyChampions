...
export default function TrainingPlanBuilderScreen() {
  ...
  }, [navigation, savedSessionsSnapshot, setIsDirty]);
  ...
  if (state.kind === 'error') {
    return (
      <DsScreen
        ...
        testID="pro.training_plan.errorState"
      >
        ...
        <DsPillButton
          ...
          fullWidth={false}
          testID="pro.training_plan.retryButton"
        />
      </DsScreen>
    );
  }
  ...
  return (
    ...
    >
      ...
      <DiscardChangesModal
        ...
        testID="pro.training_plan.discard.dialog"
      />
