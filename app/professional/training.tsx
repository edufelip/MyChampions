 ...
 * Refs: D-013, D-080, D-111, FR-111, FR-112, FR-223, FR-244,
...
export default function ProTrainingLibraryScreen() {
  ...
  const trainingPlans: PredefinedPlan[] =
    state.kind === 'ready'
      ? state.predefinedPlans.filter((p) => p.planType === 'training')
      : [];
        ...
        <FlatList
          ...
          ListFooterComponent={
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel={t('pro.library.training.cta_create')}
            >
              <Text style={[styles.primaryBtnText, { color: palette.background }]}>
                {t('pro.library.training.cta_create')}
              </Text>
            </Pressable>
          }
        />
