...
- Done/Return-key, primary CTA, and Google/Apple provider actions share one serialized submission gate; a second account request is ignored until the active request settles.
