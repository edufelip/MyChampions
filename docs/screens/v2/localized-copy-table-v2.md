...
| `student.training.empty.title` | SC-210 | Tracking empty state | No workout scheduled yet | Nenhum treino agendado ainda | Aún no hay entrenamiento programado | |
| `student.training.empty.helper` | SC-210 | Tracking empty helper | No coach connected? You can still create your own training plan now. | Sem treinador conectado? Você ainda pode criar seu próprio plano de treino agora. | ¿Sin entrenador conectado? Aún puedes crear tu propio plan de entrenamiento ahora. | Must preserve optionality |
| `student.training.empty.cta` | SC-210 | Tracking empty CTA | Start my training plan | Começar meu plano de treino | Iniciar mi plan de entrenamiento | |
