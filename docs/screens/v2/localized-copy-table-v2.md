...
| `pro.students.empty.body` | SC-205 | Roster empty-state helper | Start transforming lives by adding your first student or sharing your invite link. | Comece a transformar vidas adicionando seu primeiro aluno ou compartilhando seu link de convite. | Empieza a transformar vidas añadiendo tu primer alumno o compartiendo tu enlace de invitación. | Empty-state hero helper |
| `pro.students.empty.cta_add_first` | SC-205 | Empty-state primary CTA | Add first student | Adicionar primeiro aluno | Añadir primer alumno | Routes to `/professional/home` |
