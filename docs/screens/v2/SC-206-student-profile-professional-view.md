...
- Plan records (assigned/self-managed/archived).
  - Student hydration goal state (personal + nutritionist override metadata).
...
- Outputs:
  ...
  - Student water-goal override updates.
...
- Water-goal override actions are available only when professional has active nutrition assignment for that student.

## Links
- Functional requirement: FR-106, FR-107, FR-108, FR-121, FR-123, FR-124, FR-125, FR-130, FR-131, FR-185, FR-211, FR-221, FR-222
- Use case: UC-002.2, UC-002.3, UC-002.5, UC-002.6, UC-002.13, UC-002.19
- Acceptance criteria: AC-203, AC-204, AC-205, AC-214, AC-216, AC-217, AC-218, AC-222, AC-255, AC-261, AC-262, AC-311
- Business rules: BR-203, BR-204, BR-205, BR-213, BR-215, BR-216, BR-217, BR-222, BR-223, BR-247, BR-269, BR-278, BR-279
- Test cases: TC-204, TC-205, TC-214, TC-216, TC-217, TC-218, TC-219, TC-223, TC-259, TC-266, TC-267, TC-310
