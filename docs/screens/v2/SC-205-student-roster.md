...
- Pending-row selection toggles only through the row's dedicated checkbox control, not by pressing elsewhere in the row; this keeps the row itself non-interactive so Accept/Deny remain sibling, independently operable controls (ET-106, D-203).
