...
| Complete flow atlas     | `yarn test:e2e:web:flow-atlas`              | Chromium at mobile/tablet/web widths | Exhaustive implemented-flow evidence and manual review  | 13 flow folders, 65 base checkpoints per platform plus 4 mobile-only auth checkpoints (199 total), exact-name verifier, auth/app HTML reports. Local only; not wired to CI.                                                                                                                                                                             |
