...
| Functional              | `yarn test:e2e:web:functional`              | Chromium, Firefox, WebKit            | Platform-specific behavior                              | Camera-denied manual invite fallback, subscription mobile-handoff surface, and Pixel 5 exercise-search dialog geometry.                                                                                                                                                                                                                                                                             |
...
mobile emulation to assert the initial dialog bounds, focus, search result, and
close behavior before a query can mask an off-screen opening state.
