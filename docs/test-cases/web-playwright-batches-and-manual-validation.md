...
| Functional              | `yarn test:e2e:web:functional`              | Chromium, Firefox, WebKit            | Platform-specific behavior                              | Camera-denied manual invite fallback, subscription mobile-handoff surface, plan-builder fail-closed recovery, independent Student Nutrition meal controls, and unsaved training-plan discard confirmation.                                                                                                                                                                                                            |
