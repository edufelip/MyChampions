...
- `AC-512`: Core screens meet accessibility baseline for contrast, dynamic text scaling, focus order, and screen-reader labels. Expandable workout-session controls expose localized labels and their expanded/collapsed state.
