...
- `Done`: Fresh SC-207/SC-208 professional builder initialization runs after the route-scope reset, preserves Ready, and exposes the first Add meal/Add session action on mobile web at 390x844 and 320x720 (ET-94, D-203, TC-275A, TC-278A).
